...
Generated 2026-09-21 by `.advocate-engine/bin/digest.mjs`. Do not edit it — edit the seat.

| seat | last spoke | sessions | draft | ready | state |
| --- | --- | --- | --- | --- | --- |
| [`clerk`](clerk.md) | 2026-09-21 | 9 | 0 | 0 | up to date |
| [`no-card`](no-card.md) | 2026-09-20 | 8 | 2 | 0 | up to date |
